  ...
  return (
    <div className="content content--table">
      ...
      {(tab === 'provider' || tab === 'wingo') && summary && records.length > 0 && (
        <div style={{ display: 'flex', gap: 32, background: '#fff', border: '1px solid #d0d0d0', borderRadius: 4, padding: '12px 20px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', margin: '12px 0' }}>
