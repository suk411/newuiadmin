...
function StatCard({ label, value, color }: { label: string; value: string; color?: string }) {
  return (
    <div className="stat-card-inline">
      ...
      <span className="stat-card-inline__value" style={color ? { color } : undefined}>{value}</span>
    </div>
  )
}
  ...
  return (
    <div className="content">
      ...
      <section aria-label="Deposit statistics">
        <h2 className="section-title section-title--spaced">Deposits</h2>
        <div className="dashboard-card">
      ...
      <section aria-label="Withdrawal statistics">
        <h2 className="section-title section-title--spaced">Withdrawals</h2>
        <div className="dashboard-card">
      ...
      <section aria-label="Agent commission">
        <h2 className="section-title section-title--spaced">Agent Commission</h2>
        <div className="dashboard-card">
