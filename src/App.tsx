      ...
      <div className="main-area">
        <header className="app-header">
          <div className="header-left">
            ...
            <span className="header-title">Recharge List</span>
          ...
          <div className="header-right">
            ...
            <button className="btn-filled header-btn">+ New Recharge</button>
            <span className="header-admin-label">Admin</span>
            <button className="btn-filled-2" onClick={handleLogout} style={{ cursor: 'pointer' }}>Logout</button>
          </div>
        </header>
